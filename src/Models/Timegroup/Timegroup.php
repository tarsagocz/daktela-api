 ...
 * Created at: 11:01 08.10.2019
 */

namespace Daktela\Models\Timegroup;

use Daktela\AbstractModel;
use Daktela\Models\FetchableTrait;
use Daktela\Models\ReadableTrait;

class Timegroup extends AbstractModel
{
    use FetchableTrait;
    use ReadableTrait;
    const MODEL = 'timegroups';
    /**
     * @var string|null
     */
    protected $name;
     ...
     * @return Timegroup
     */
    public static function createFromRow(array $row): Timegroup
    {
        var_dump($row);
